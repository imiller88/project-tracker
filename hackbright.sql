...
SELECT pg_catalog.setval('grades_id_seq', 2, true);
...
COPY projects (title, description, max_grade, id) FROM stdin;
Markov	Tweets generated from Markov chains	50	1
Blockly	Programmatic Logic Puzzle Game	100	2
Madlibs	Madlibs	50	4
flask	flask	70	5
html	html	100	6
\.
